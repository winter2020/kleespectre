...
void victim_fun(int idx, int k) {
  ...
  40053d:	3b 34 25 40 10 60 00 	cmp    0x601040,%esi
  400544:	0f 83 35 00 00 00    	jae    40057f <victim_fun+0x4f>
        if (array1[idx] == k)
  40054a:	48 63 45 fc          	movslq -0x4(%rbp),%rax
  40054e:	0f b6 0c 05 60 10 60 	movzbl 0x601060(,%rax,1),%ecx
  400555:	00 
  400556:	3b 4d f8             	cmp    -0x8(%rbp),%ecx
  400559:	0f 85 1b 00 00 00    	jne    40057a <victim_fun+0x4a>
            temp &= array2[0];
  40055f:	0f b6 04 25 70 10 60 	movzbl 0x601070,%eax
  400566:	00 
  400567:	0f b6 0c 25 51 10 60 	movzbl 0x601051,%ecx
  40056e:	00 
  40056f:	21 c1                	and    %eax,%ecx
  400571:	88 ca                	mov    %cl,%dl
  400573:	88 14 25 51 10 60 00 	mov    %dl,0x601051
    }
  40057a:	e9 00 00 00 00       	jmpq   40057f <victim_fun+0x4f>
}
  40057f:	5d                   	pop    %rbp
  400580:	c3                   	retq   
