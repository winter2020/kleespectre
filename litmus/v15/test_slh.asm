...
void victim_fun(size_t *idx) {
  ...
  40054a:	48 c1 f8 3f          	sar    $0x3f,%rax
    if (*idx < array1_size) {                  
  40054e:	48 8b 17             	mov    (%rdi),%rdx
  400551:	48 09 c2             	or     %rax,%rdx
  400554:	8b 35 e6 0a 20 00    	mov    0x200ae6(%rip),%esi        # 601040 <array1_size>
  40055a:	48 39 f2             	cmp    %rsi,%rdx
  40055d:	73 22                	jae    400581 <victim_fun+0x41>
  40055f:	48 0f 43 c1          	cmovae %rcx,%rax
        temp &= array2[array1[*idx] * 512];
  400563:	0f b6 8a 60 10 60 00 	movzbl 0x601060(%rdx),%ecx
  40056a:	48 c1 e1 09          	shl    $0x9,%rcx
  40056e:	48 09 c1             	or     %rax,%rcx
  400571:	8a 89 70 10 60 00    	mov    0x601070(%rcx),%cl
  400577:	08 c1                	or     %al,%cl
  400579:	20 0d d2 0a 20 00    	and    %cl,0x200ad2(%rip)        # 601051 <temp>
  40057f:	eb 04                	jmp    400585 <victim_fun+0x45>
  400581:	48 0f 42 c1          	cmovb  %rcx,%rax
    }
}
  400585:	48 c1 e0 2f          	shl    $0x2f,%rax
  400589:	48 09 c4             	or     %rax,%rsp
  40058c:	c3                   	retq   
...
void victim_fun(size_t *idx) {
  ...
  400606:	48 39 f2             	cmp    %rsi,%rdx
  400609:	73 2d                	jae    400638 <main+0xa8>
  ...
  400638:	48 0f 42 cb          	cmovb  %rbx,%rcx
        return 1;
