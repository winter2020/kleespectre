...
void victim_fun(int idx) {
  ...
  400541:	0f 83 5d 00 00 00    	jae    4005a4 <victim_fun+0x74>
        for (i = idx - 1; i >= 0; i--) 
  400547:	8b 45 fc             	mov    -0x4(%rbp),%eax
  40054a:	83 e8 01             	sub    $0x1,%eax
  40054d:	48 63 c8             	movslq %eax,%rcx
  400550:	48 89 4d f0          	mov    %rcx,-0x10(%rbp)
  400554:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
  400559:	0f 82 40 00 00 00    	jb     40059f <victim_fun+0x6f>
            temp &= array2[array1[idx] * 512];
  40055f:	48 63 45 fc          	movslq -0x4(%rbp),%rax
  400563:	0f b6 0c 05 60 10 60 	movzbl 0x601060(,%rax,1),%ecx
  40056a:	00 
  40056b:	c1 e1 09             	shl    $0x9,%ecx
  40056e:	48 63 c1             	movslq %ecx,%rax
  400571:	0f b6 0c 05 70 10 60 	movzbl 0x601070(,%rax,1),%ecx
  400578:	00 
  400579:	0f b6 14 25 51 10 60 	movzbl 0x601051,%edx
  400580:	00 
  400581:	21 ca                	and    %ecx,%edx
  400583:	40 88 d6             	mov    %dl,%sil
  400586:	40 88 34 25 51 10 60 	mov    %sil,0x601051
  40058d:	00 
...
void victim_fun(int idx) {
    ...
    if (idx < array1_size) {                  
        for (i = idx - 1; i >= 0; i--) 
  40058e:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  400592:	48 83 c0 ff          	add    $0xffffffffffffffff,%rax
  400596:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
  40059a:	e9 b5 ff ff ff       	jmpq   400554 <victim_fun+0x24>
            temp &= array2[array1[idx] * 512];
    }
  40059f:	e9 00 00 00 00       	jmpq   4005a4 <victim_fun+0x74>
}
  4005a4:	5d                   	pop    %rbp
  4005a5:	c3                   	retq   
