...
void victim_fun(size_t x, int *x_is_safe) {
  ...
  40054e:	8b 16                	mov    (%rsi),%edx
  400550:	09 c2                	or     %eax,%edx
  400552:	3b 15 e8 0a 20 00    	cmp    0x200ae8(%rip),%edx        # 601040 <array1_size>
  400558:	73 22                	jae    40057c <victim_fun+0x3c>
  40055a:	48 0f 43 c1          	cmovae %rcx,%rax
        temp &= array2[array1[x] * 512];
  40055e:	0f b6 8f 60 10 60 00 	movzbl 0x601060(%rdi),%ecx
  400565:	48 c1 e1 09          	shl    $0x9,%rcx
  400569:	48 09 c1             	or     %rax,%rcx
  40056c:	8a 89 70 10 60 00    	mov    0x601070(%rcx),%cl
  400572:	08 c1                	or     %al,%cl
  400574:	20 0d d7 0a 20 00    	and    %cl,0x200ad7(%rip)        # 601051 <temp>
  40057a:	eb 04                	jmp    400580 <victim_fun+0x40>
  40057c:	48 0f 42 c1          	cmovb  %rcx,%rax
    }
}
  400580:	48 c1 e0 2f          	shl    $0x2f,%rax
  400584:	48 09 c4             	or     %rax,%rsp
  400587:	c3                   	retq   
...
void victim_fun(size_t x, int *x_is_safe) {
    if (*x_is_safe < array1_size) {                  
  4005ff:	3b 0d 3b 0a 20 00    	cmp    0x200a3b(%rip),%ecx        # 601040 <array1_size>
  400605:	73 30                	jae    400637 <main+0xa7>
  400607:	48 0f 43 d3          	cmovae %rbx,%rdx
    if (file == NULL)
        return 1;
...
void victim_fun(size_t x, int *x_is_safe) {
  ...
  40062a:	eb 0f                	jmp    40063b <main+0xab>
  40062c:	48 0f 45 d3          	cmovne %rbx,%rdx
  400630:	b8 01 00 00 00       	mov    $0x1,%eax
  400635:	eb 04                	jmp    40063b <main+0xab>
  400637:	48 0f 42 d3          	cmovb  %rbx,%rdx
  ...
  40063b:	48 c1 e2 2f          	shl    $0x2f,%rdx
  40063f:	48 09 d4             	or     %rdx,%rsp
  400642:	5b                   	pop    %rbx
  400643:	c3                   	retq   
