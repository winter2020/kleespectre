...
void victim_fun(int x, int y) {
  ...
  40054a:	48 c1 f8 3f          	sar    $0x3f,%rax
    if ((x + y) < array1_size) {                  
  40054e:	01 f7                	add    %esi,%edi
  400550:	3b 3d ea 0a 20 00    	cmp    0x200aea(%rip),%edi        # 601040 <array1_size>
  400556:	73 25                	jae    40057d <victim_fun+0x3d>
  400558:	48 0f 43 c1          	cmovae %rcx,%rax
        temp &= array2[array1[x + y] * 512];
  40055c:	48 63 cf             	movslq %edi,%rcx
  ...
  40057b:	eb 04                	jmp    400581 <victim_fun+0x41>
  40057d:	48 0f 42 c1          	cmovb  %rcx,%rax
    }
}
  400581:	48 c1 e0 2f          	shl    $0x2f,%rax
  400585:	48 09 c4             	or     %rax,%rsp
  400588:	c3                   	retq   
...
void victim_fun(int x, int y) {
    if ((x + y) < array1_size) {                  
  4005fb:	8d 14 00             	lea    (%rax,%rax,1),%edx
  4005fe:	83 c2 03             	add    $0x3,%edx
  400601:	31 c0                	xor    %eax,%eax
  400603:	3b 15 37 0a 20 00    	cmp    0x200a37(%rip),%edx        # 601040 <array1_size>
  400609:	73 30                	jae    40063b <main+0xab>
  40060b:	48 0f 43 cb          	cmovae %rbx,%rcx
        temp &= array2[array1[x + y] * 512];
  40060f:	48 63 d2             	movslq %edx,%rdx
  400612:	0f b6 92 60 10 60 00 	movzbl 0x601060(%rdx),%edx
  400619:	48 c1 e2 09          	shl    $0x9,%rdx
  40061d:	48 09 ca             	or     %rcx,%rdx
  400620:	8a 92 70 10 60 00    	mov    0x601070(%rdx),%dl
  400626:	08 ca                	or     %cl,%dl
  400628:	20 15 23 0a 20 00    	and    %dl,0x200a23(%rip)        # 601051 <temp>
  40062e:	eb 0f                	jmp    40063f <main+0xaf>
  400630:	48 0f 45 cb          	cmovne %rbx,%rcx
  400634:	b8 01 00 00 00       	mov    $0x1,%eax
  400639:	eb 04                	jmp    40063f <main+0xaf>
  40063b:	48 0f 42 cb          	cmovb  %rbx,%rcx
  ...
  40063f:	48 c1 e1 2f          	shl    $0x2f,%rcx
  400643:	48 09 cc             	or     %rcx,%rsp
  400646:	5b                   	pop    %rbx
  400647:	c3                   	retq   
