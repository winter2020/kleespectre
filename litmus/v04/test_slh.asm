...
void victim_fun(int idx) {
  ...
  400554:	76 27                	jbe    40057d <victim_fun+0x3d>
  400556:	48 0f 46 c1          	cmovbe %rcx,%rax
        temp &= array2[array1[idx << 1] * 512];
  40055a:	01 ff                	add    %edi,%edi
  ...
  40057d:	48 0f 47 c1          	cmova  %rcx,%rax
    }
}
...
int main(int argn, char* args[]) {
  ...
  4005cf:	74 5d                	je     40062e <main+0x9e>
...
void victim_fun(int idx) {
  ...
  400605:	76 32                	jbe    400639 <main+0xa9>
  400607:	48 0f 46 d3          	cmovbe %rbx,%rdx
        temp &= array2[array1[idx << 1] * 512];
  40060b:	01 c9                	add    %ecx,%ecx
  40060d:	48 63 c9             	movslq %ecx,%rcx
  400610:	0f b6 89 60 10 60 00 	movzbl 0x601060(%rcx),%ecx
  400617:	48 c1 e1 09          	shl    $0x9,%rcx
  40061b:	48 09 d1             	or     %rdx,%rcx
  40061e:	8a 89 70 10 60 00    	mov    0x601070(%rcx),%cl
  400624:	08 d1                	or     %dl,%cl
  400626:	20 0d 25 0a 20 00    	and    %cl,0x200a25(%rip)        # 601051 <temp>
  40062c:	eb 0f                	jmp    40063d <main+0xad>
  40062e:	48 0f 45 d3          	cmovne %rbx,%rdx
  400632:	b8 01 00 00 00       	mov    $0x1,%eax
  400637:	eb 04                	jmp    40063d <main+0xad>
  400639:	48 0f 47 d3          	cmova  %rbx,%rdx
        return 1;
  ...
  40063d:	48 c1 e2 2f          	shl    $0x2f,%rdx
  400641:	48 09 d4             	or     %rdx,%rsp
  400644:	5b                   	pop    %rbx
  400645:	c3                   	retq   
