...
void victim_fun(int idx) {
  ...
  400554:	76 25                	jbe    40057b <victim_fun+0x3b>
  400556:	48 0f 46 c1          	cmovbe %rcx,%rax
        temp = memcmp(&temp, array2 + (array1[idx] * 512), 1);
  40055a:	48 63 cf             	movslq %edi,%rcx
  40055d:	0f b6 89 60 10 60 00 	movzbl 0x601060(%rcx),%ecx
  400564:	48 c1 e1 09          	shl    $0x9,%rcx
  400568:	48 09 c1             	or     %rax,%rcx
  40056b:	8a 89 70 10 60 00    	mov    0x601070(%rcx),%cl
  400571:	08 c1                	or     %al,%cl
  400573:	28 0d d8 0a 20 00    	sub    %cl,0x200ad8(%rip)        # 601051 <temp>
  400579:	eb 04                	jmp    40057f <victim_fun+0x3f>
  40057b:	48 0f 47 c1          	cmova  %rcx,%rax
    }
}
  40057f:	48 c1 e0 2f          	shl    $0x2f,%rax
  400583:	48 09 c4             	or     %rax,%rsp
  400586:	c3                   	retq   
...
void victim_fun(int idx) {
  ...
  400605:	76 30                	jbe    400637 <main+0xa7>
  ...
  400624:	28 0d 27 0a 20 00    	sub    %cl,0x200a27(%rip)        # 601051 <temp>
  ...
  400637:	48 0f 47 d3          	cmova  %rbx,%rdx
        return 1;
