...
void victim_fun(int idx) {
  ...
  40054e:	8b 15 f0 0a 20 00    	mov    0x200af0(%rip),%edx        # 601044 <array_size_mask>
    if ((idx & array_size_mask) == idx) {                  
  400554:	21 fa                	and    %edi,%edx
  400556:	39 fa                	cmp    %edi,%edx
  400558:	75 25                	jne    40057f <victim_fun+0x3f>
  40055a:	48 0f 45 c1          	cmovne %rcx,%rax
        temp &= array2[array1[idx] * 512];
  40055e:	48 63 cf             	movslq %edi,%rcx
  400561:	0f b6 89 60 10 60 00 	movzbl 0x601060(%rcx),%ecx
  400568:	48 c1 e1 09          	shl    $0x9,%rcx
  40056c:	48 09 c1             	or     %rax,%rcx
  40056f:	8a 89 70 10 60 00    	mov    0x601070(%rcx),%cl
  400575:	08 c1                	or     %al,%cl
  400577:	20 0d d4 0a 20 00    	and    %cl,0x200ad4(%rip)        # 601051 <temp>
  40057d:	eb 04                	jmp    400583 <victim_fun+0x43>
  40057f:	48 0f 44 c1          	cmove  %rcx,%rax
    }
}
  400583:	48 c1 e0 2f          	shl    $0x2f,%rax
  400587:	48 09 c4             	or     %rax,%rsp
  40058a:	c3                   	retq   
...
int main(int argn, char* args[]) {
  ...
  4005fd:	8b 35 41 0a 20 00    	mov    0x200a41(%rip),%esi        # 601044 <array_size_mask>
uint8_t array2[256 * 512];
uint8_t temp = 0;
...
void victim_fun(int idx) {
    if ((idx & array_size_mask) == idx) {                  
  400603:	21 c6                	and    %eax,%esi
  400605:	31 c0                	xor    %eax,%eax
  400607:	39 ce                	cmp    %ecx,%esi
  400609:	75 30                	jne    40063b <main+0xab>
  40060b:	48 0f 45 d3          	cmovne %rbx,%rdx
        temp &= array2[array1[idx] * 512];
  40060f:	48 63 c9             	movslq %ecx,%rcx
  400612:	0f b6 89 60 10 60 00 	movzbl 0x601060(%rcx),%ecx
  400619:	48 c1 e1 09          	shl    $0x9,%rcx
  40061d:	48 09 d1             	or     %rdx,%rcx
  400620:	8a 89 70 10 60 00    	mov    0x601070(%rcx),%cl
  400626:	08 d1                	or     %dl,%cl
  400628:	20 0d 23 0a 20 00    	and    %cl,0x200a23(%rip)        # 601051 <temp>
  40062e:	eb 0f                	jmp    40063f <main+0xaf>
  400630:	48 0f 45 d3          	cmovne %rbx,%rdx
  400634:	b8 01 00 00 00       	mov    $0x1,%eax
  400639:	eb 04                	jmp    40063f <main+0xaf>
  40063b:	48 0f 44 d3          	cmove  %rbx,%rdx
        return 1;
  ...
  40063f:	48 c1 e2 2f          	shl    $0x2f,%rdx
  400643:	48 09 d4             	or     %rdx,%rsp
  400646:	5b                   	pop    %rbx
  400647:	c3                   	retq   
