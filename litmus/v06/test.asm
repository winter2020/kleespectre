...
void victim_fun(int idx) {
  ...
  40053a:	23 3c 25 44 10 60 00 	and    0x601044,%edi
  400541:	3b 7d fc             	cmp    -0x4(%rbp),%edi
  400544:	0f 85 2f 00 00 00    	jne    400579 <victim_fun+0x49>
        temp &= array2[array1[idx] * 512];
  40054a:	48 63 45 fc          	movslq -0x4(%rbp),%rax
  40054e:	0f b6 0c 05 60 10 60 	movzbl 0x601060(,%rax,1),%ecx
  400555:	00 
  400556:	c1 e1 09             	shl    $0x9,%ecx
  400559:	48 63 c1             	movslq %ecx,%rax
  40055c:	0f b6 0c 05 70 10 60 	movzbl 0x601070(,%rax,1),%ecx
  400563:	00 
  400564:	0f b6 14 25 51 10 60 	movzbl 0x601051,%edx
  40056b:	00 
  40056c:	21 ca                	and    %ecx,%edx
  40056e:	40 88 d6             	mov    %dl,%sil
  400571:	40 88 34 25 51 10 60 	mov    %sil,0x601051
  400578:	00 
    }
}
  400579:	5d                   	pop    %rbp
