...
void victim_fun(int idx) {
  ...
  400541:	0f 83 0e 00 00 00    	jae    400555 <victim_fun+0x25>
  400547:	8b 45 fc             	mov    -0x4(%rbp),%eax
  40054a:	83 c0 01             	add    $0x1,%eax
  40054d:	89 45 f8             	mov    %eax,-0x8(%rbp)
  400550:	e9 0a 00 00 00       	jmpq   40055f <victim_fun+0x2f>
  400555:	31 c0                	xor    %eax,%eax
  400557:	89 45 f8             	mov    %eax,-0x8(%rbp)
  40055a:	e9 00 00 00 00       	jmpq   40055f <victim_fun+0x2f>
  40055f:	8b 45 f8             	mov    -0x8(%rbp),%eax
  400562:	48 63 c8             	movslq %eax,%rcx
  400565:	0f b6 04 0d 60 10 60 	movzbl 0x601060(,%rcx,1),%eax
  40056c:	00 
  40056d:	c1 e0 09             	shl    $0x9,%eax
  400570:	48 63 c8             	movslq %eax,%rcx
  400573:	0f b6 04 0d 70 10 60 	movzbl 0x601070(,%rcx,1),%eax
  40057a:	00 
  40057b:	0f b6 14 25 51 10 60 	movzbl 0x601051,%edx
  400582:	00 
  400583:	21 c2                	and    %eax,%edx
  400585:	40 88 d6             	mov    %dl,%sil
  400588:	40 88 34 25 51 10 60 	mov    %sil,0x601051
  40058f:	00 
}
  400590:	5d                   	pop    %rbp
  400591:	c3                   	retq   
