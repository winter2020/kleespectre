...
void victim_fun(int idx) {
  ...
  400554:	76 2c                	jbe    400582 <victim_fun+0x42>
  400556:	48 0f 46 c1          	cmovbe %rcx,%rax
         temp &= array2[array1[idx ^ 255] * 512];
  40055a:	48 63 cf             	movslq %edi,%rcx
  40055d:	48 81 f1 ff 00 00 00 	xor    $0xff,%rcx
  400564:	0f b6 89 60 10 60 00 	movzbl 0x601060(%rcx),%ecx
  40056b:	48 c1 e1 09          	shl    $0x9,%rcx
  40056f:	48 09 c1             	or     %rax,%rcx
  400572:	8a 89 70 10 60 00    	mov    0x601070(%rcx),%cl
  400578:	08 c1                	or     %al,%cl
  40057a:	20 0d d1 0a 20 00    	and    %cl,0x200ad1(%rip)        # 601051 <temp>
  400580:	eb 04                	jmp    400586 <victim_fun+0x46>
  400582:	48 0f 47 c1          	cmova  %rcx,%rax
    }
}
...
int main(int argn, char* args[]) {
  ...
  4005cf:	74 62                	je     400633 <main+0xa3>
...
void victim_fun(int idx) {
  ...
  400605:	76 37                	jbe    40063e <main+0xae>
  400607:	48 0f 46 d3          	cmovbe %rbx,%rdx
         temp &= array2[array1[idx ^ 255] * 512];
  40060b:	48 63 c9             	movslq %ecx,%rcx
  40060e:	48 81 f1 ff 00 00 00 	xor    $0xff,%rcx
  400615:	0f b6 89 60 10 60 00 	movzbl 0x601060(%rcx),%ecx
  40061c:	48 c1 e1 09          	shl    $0x9,%rcx
  400620:	48 09 d1             	or     %rdx,%rcx
  400623:	8a 89 70 10 60 00    	mov    0x601070(%rcx),%cl
  400629:	08 d1                	or     %dl,%cl
  40062b:	20 0d 20 0a 20 00    	and    %cl,0x200a20(%rip)        # 601051 <temp>
  400631:	eb 0f                	jmp    400642 <main+0xb2>
  400633:	48 0f 45 d3          	cmovne %rbx,%rdx
  400637:	b8 01 00 00 00       	mov    $0x1,%eax
  40063c:	eb 04                	jmp    400642 <main+0xb2>
  40063e:	48 0f 47 d3          	cmova  %rbx,%rdx
        return 1;
  ...
  400642:	48 c1 e2 2f          	shl    $0x2f,%rdx
  400646:	48 09 d4             	or     %rdx,%rsp
  400649:	5b                   	pop    %rbx
  40064a:	c3                   	retq   
