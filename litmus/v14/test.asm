...
void victim_fun(int idx) {
  ...
  400541:	0f 83 36 00 00 00    	jae    40057d <victim_fun+0x4d>
         temp &= array2[array1[idx ^ 255] * 512];
  400547:	8b 45 fc             	mov    -0x4(%rbp),%eax
  40054a:	35 ff 00 00 00       	xor    $0xff,%eax
  40054f:	48 63 c8             	movslq %eax,%rcx
  400552:	0f b6 04 0d 60 10 60 	movzbl 0x601060(,%rcx,1),%eax
  400559:	00 
  40055a:	c1 e0 09             	shl    $0x9,%eax
  40055d:	48 63 c8             	movslq %eax,%rcx
  400560:	0f b6 04 0d 70 10 60 	movzbl 0x601070(,%rcx,1),%eax
  400567:	00 
  400568:	0f b6 14 25 51 10 60 	movzbl 0x601051,%edx
  40056f:	00 
  400570:	21 c2                	and    %eax,%edx
  400572:	40 88 d6             	mov    %dl,%sil
  400575:	40 88 34 25 51 10 60 	mov    %sil,0x601051
  40057c:	00 
    }
}
  40057d:	5d                   	pop    %rbp
