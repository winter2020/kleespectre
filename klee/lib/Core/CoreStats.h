...
namespace stats {
  ...
  /* SPSE */
  extern Statistic loads;
  extern Statistic stores;

  extern Statistic constLoads;
  extern Statistic constStores;

  extern Statistic spLoads;
  extern Statistic spStores;


  extern Statistic spStates;
  extern Statistic spStatesDone;
  extern Statistic totalSpecInst;
